...
def cot_all_reports(store_txt=True, verbose=True):
    ...
    return (
        vars()["{}".format("legacy_fut")],
        vars()["{}".format("legacy_futopt")],
        vars()["{}".format("supplemental_futopt")],
        vars()["{}".format("disaggregated_fut")],
        vars()["{}".format("disaggregated_futopt")],
        vars()["{}".format("traders_in_financial_futures_fut")],
